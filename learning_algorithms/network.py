...
class Network(object):
    def __init__(self, sizes, l2=0, output_function=sigmoid, output_derivative=sigmoid_prime):
        """
        ...
        (входном), тремя нейронами во втором (промежуSточном) и одним нейроном
    ...
    def update_mini_batch(self, mini_batch, eta):
        ...
        self.weights = [w - eps * nw - self.l2 * nw for w, nw in zip(self.weights, nabla_w)]
